...
with col1:
    st.metric(
        ...
        delta=f"{results['our_monthly_yield'] / results['our_in_range_position'] * 100:.1f}% monthly return" if results[
                                                                                                                    'our_in_range_position'] > 0 else None
    )
...
st.markdown("---")
st.markdown(
    "*This calculator assumes others maintain 100% in-range positions. Actual yields may vary based on competitor behavior.*")
